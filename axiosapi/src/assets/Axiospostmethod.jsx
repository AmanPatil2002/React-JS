...
function Axiospostmethod() {
    ...
    function editdata(id){
        ...
        axios.put(`hhtp://jsonplaceholder.typicode.com/users/${u.id}`,JSON.stringify(u)).then((res)=>{
            console.log(res)
        })
    }
    function deldata(id){
        axios.delete(`hhtp://jsonplaceholder.typicode.com/users/${u.id}`,JSON.stringify(u)).then((res)=>{
            console.log(res)
        })
    }
  return (
