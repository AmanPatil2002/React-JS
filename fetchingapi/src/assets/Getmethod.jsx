  ...
  return (
    <div>
        ...
        <table border={2} cellPadding={10}>
            <thead>
                <tr><th>ID</th><th>NAME</th><th>EMAIL</th><th>CITY</th><th>PHONE</th><th>BUTTON</th></tr>
            </thead>
            <tbody>
                {
                    emp.map((e,i)=>{
                        return (
                            <tr key={i}>
                                ...
                                <td>{e.city}</td>
                                <td>{e.phone}</td>
                                <td><button onClick={()=>selemp(e)}>Edit</button>
                                <button onClick={()=>delemp(e)}>Delete</button></td>
                            </tr>
                        )
                    })
                }
